...
public class GerenciadorDeSessaoTest {
	...
	public void preparaSessoes(){
		...
		this.sessaoDasDez = new Sessao(LocalTime.parse("10:00:00"), rogueOne, sala3D, BigDecimal.ONE);
		this.sessaoDasTreze= new Sessao(LocalTime.parse("13:00:00"), rogueOne, sala3D, BigDecimal.ONE);
		this.sessaoDasDezoito = new Sessao(LocalTime.parse("18:00:00"), rogueOne, sala3D, BigDecimal.ONE);
	}
	...
	public void garanteQueNaoDevePermitirSessoesTerminandoDentroDoHorarioDeUmaSessaoJaExistente(){
		List<Sessao> sessoes = Arrays.asList(sessaoDasDez);
		Sessao sessao = new Sessao(sessaoDasDez.getHorario().minusHours(1), rogueOne, sala3D, BigDecimal.ONE);
	...
	public void garanteQueNaoDevePermitirSessoesIniciandoDentroDoHorarioDeUmaSessaoJaExistente(){
		List<Sessao> sessoes = Arrays.asList(sessaoDasDez);
		Sessao sessao = new Sessao(sessaoDasDez.getHorario().plusHours(1), rogueOne, sala3D, BigDecimal.ONE);
